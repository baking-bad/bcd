...
export function newRouter(networks) {
  return new Router({
    ...
    routes: [
      ...
      {
        path: '/:network(mainnet|ghostnet|limanet|mumbainet|sandboxnet)/opg/:hash(o[0-9A-z]{50})',
        alias: '/:network(mainnet|ghostnet|limanet|mumbainet|sandboxnet)/:hash(o[0-9A-z]{50})',
        components: {
