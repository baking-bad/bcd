...
export function newRouter(networks) {
  return new VueRouter({
    ...
    routes: [
      ...
      {
        path: '/:network(mainnet|ghostnet|oxfordnet|sandboxnet|mondaynet|dailynet|rollupnet)/opg/:hash(o[0-9A-z]{50})',
        alias: '/:network(mainnet|ghostnet|oxfordnet|sandboxnet|mondaynet|dailynet|rollupnet)/:hash(o[0-9A-z]{50})',
        components: {
